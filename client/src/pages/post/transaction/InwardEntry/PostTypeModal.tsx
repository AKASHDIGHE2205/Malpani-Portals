...
import { getPostType } from "../../../../services/post/Transaction/TransactionsAPI";
import { handleSelectPostType } from "../../../../feature/post/PostEntrySlice";
...
const PostTypeModal: FC<Props> = ({ show, setShow }) => {
  ...
  return (
    ...
    <div id="postModal" className={`fixed inset-0 bg-gray-600 dark:bg-gray-900 bg-opacity-50 dark:bg-opacity-75 flex items-center justify-center ${show ? 'flex' : 'hidden'}`}>
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl dark:shadow-gray-900 max-w-2xl w-full mx-4 max-h-[90vh] overflow-hidden">
        <div className="p-6">
          ...
          <div className="sticky top-0 bg-white dark:bg-gray-800 pb-4">
            <div className="mb-4">
              <h1 className="text-xl font-bold text-gray-800 dark:text-white">Select Post Type from list...!</h1>
            </div>
              ...
              <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                {currentItems.map((item: any, index: number) => (
                  <tr key={index} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                    <td className="px-4 py-2 whitespace-nowrap text-sm text-gray-900 dark:text-gray-300">{item.post_id}</td>
                    <td className="px-4 py-2 whitespace-nowrap text-sm text-gray-900 dark:text-gray-300">{item.post_name}</td>
